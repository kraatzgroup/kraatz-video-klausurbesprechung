...
## The 400 Bad Request Error Fix

**Problem**: Authentication fails because database tables don't exist in Supabase yet.

**Solution**: Execute the SQL schema in Supabase Dashboard

### Quick Steps:

1. **Open Supabase Dashboard**: https://supabase.com/dashboard/project/rpgbyockvpannrupicno

2. **Go to SQL Editor** (left sidebar)

3. **Copy & Paste this SQL** (from database/schema.sql):
...
5. **Test**: Go to http://localhost:3000/register and create an account
...
2. In SQL Editor: `UPDATE public.users SET role = 'instructor' WHERE email = 'dozent@kraatz-club.de';`
