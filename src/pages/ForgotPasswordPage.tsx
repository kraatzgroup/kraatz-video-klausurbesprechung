        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              ...
              {loading ? 'Wird gesendet...' : 'Reset-E-Mail senden'}
            </button>
          </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-800">
                <strong>Hinweis:</strong> Diese Funktion ist nur für Admin- und Dozenten-Accounts verfügbar. 
                Studenten nutzen bitte die reguläre Anmeldung.
              </p>
            </div>
          </div>
        </div>
